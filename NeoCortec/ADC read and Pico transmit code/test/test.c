 ...
 * 2) UART0 and SPI0 buses can conflict, so if you need to use the SPI0 bus for SD Card saves, switch to using UART1 for the NeoCortec communications
 */
...
#define ARRAY_LEN 5 // Do not change
...
uint8_t nodeId = 0x50; //sink node ID
